...
public class MessageStore {
  ...
  /**
   * Counts the number of total messages
   */
  ...
  /**
   * Returns List<Message> of all messages sent by a user
   */
  public ArrayList<Message> allMessages(User user) {
	  ArrayList<Message> userMessages = new ArrayList<Message> ();
	  for (Message message: messages) {
		  String username = UserStore.getInstance().getUser(message.getAuthorId()).getName();
